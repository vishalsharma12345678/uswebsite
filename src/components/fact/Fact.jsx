        ...
        <section className="fact-counter-two padding-bottom" id="fact-counter">
            ...
            <div className="container">
                <div className="row" style={{display:"flex",justifyContent:"center"}} >
                    {[
                        { count: 245, text: "Parcels Shipped Safely", icon: "icon-special-shipments" },
                        { count: 48, text: "Cities Served Worldwide", icon: "icon-global-network" },
                        { count: 104, text: "Satisfied Clients", icon: "icon-satisfied3" },
